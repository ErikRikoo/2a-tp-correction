...
namespace Player
{
    ...
    // Renommage pour avoir quelque chose de plus générique
    public class GameObjectVariable : ScriptableObject
    {
        ...
        public static implicit operator Transform(GameObjectVariable _instance)
        {
            return _instance.Value.transform;
        }

        public static implicit operator GameObject(GameObjectVariable _instance)
        {
